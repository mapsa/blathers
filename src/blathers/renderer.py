...
/* Status label (inline in header) */
.status-label { font-size: 0.65rem; font-weight: 600; letter-spacing: 0.04em; text-transform: uppercase;
                padding: 0.1rem 0.4rem; border-radius: 4px; margin-left: 0.4rem; vertical-align: middle; }
.status-draft, .status-draft-specification, .status-working-draft { background: #fef3c7; color: #92400e; }
...
.narrative img, .sidecar-content img, .content img { max-width: 100%; height: auto; border-radius: 6px; }
